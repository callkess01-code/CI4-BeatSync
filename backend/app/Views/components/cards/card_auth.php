 ...
 * 
 * Data contract:
 * $config: array with keys:
 *   - type: string ('login' or 'signup')
 *   - title: string - Main heading
 *   - subtitle: string - Subheading
 *   - bgText: string - Large background text
 *   - submitButtonText: string - Submit button label
 *   - footerText: string - Footer text before link
 *   - footerLinkText: string - Footer link text
 *   - footerLinkHref: string - Footer link URL
 * 
 ...
 *   - placeholder: string
 *   - required: boolean
 *   - hasToggle: boolean (for password fields)
 */
...
<main class="auth-container">
    ...
    <header class="auth-header">
        ...
        <nav class="header-nav">
            ...
            <a href="landing#events" class="nav-link">Events</a>
            <a href="landing#tickets" class="nav-link">Tickets</a>
        </nav>
    </header>
...
<script>
    // Password toggle functionality with visibility control
